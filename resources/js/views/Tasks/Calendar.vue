        ...
        <div class="grid grid-cols-7">
          ...
          >
            <div class="flex flex-col h-full">
              ...
              <!-- Birthday icon -->
              <div v-if="day.birthdays && day.birthdays.length > 0" class="mt-auto flex justify-center">
                <svg class="w-3.5 h-3.5 text-pink-400 dark:text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
