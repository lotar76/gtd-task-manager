  ...
  <div class="space-y-3">
    ...
    >
      <svg class="w-5 h-5" viewBox="0 0 24 24">
        ...
        <path d="M13.32 7.666h-.924c-1.694 0-2.585.858-2.585 2.123 0 1.43.616 2.1 1.881 2.959l1.045.704-3.003 4.487H7.49l2.695-4.014c-1.55-1.111-2.42-2.19-2.42-3.938 0-2.222 1.529-3.65 4.283-3.65h2.717v11.6h-1.441V7.667z" fill="white"/>
      </svg>
      Yandex
    </a>
