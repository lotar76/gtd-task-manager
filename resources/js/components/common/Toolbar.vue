...
const emit = defineEmits(['quick-add', 'quick-add-task', 'quick-ai-task', 'quick-add-project', 'quick-add-goal', 'search', 'logout', 'profile', 'settings'])
